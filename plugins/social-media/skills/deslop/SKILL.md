---
name: deslop
description: Use when drafting or revising prose for social media, blog posts, marketing copy, narrative documentation, README intros, or any public-facing text — identifies and removes common AI writing tells like binary contrasts, dramatic fragmentation, false agency, anaphora abuse, and self-posed rhetorical questions before posting.
---

A field guide to the structures that mark prose as AI-generated, with a concrete fix for each. Run a draft through this list and rewrite anything that matches.
